...
def update_apical_height_in_config(folder, apical_px, px2micron):
    ...
    config["apical_detection"]["run_selection"] = "longest"
...
def main():
    ...
    config = load_px2micron(config_path)
